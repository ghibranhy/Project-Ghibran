...
Mobile.delay(2)
waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Payment/select.PaymentECV'))
Mobile.delay(2)

// Input Trip Purpose
Mobile.tapAtPosition(114, 1830)
Mobile.setText(findTestObject('Object Repository/Delivery/5. Confirmation Page/Trip Purpose/textView.TripPurpose'), 'test 123', 3)
Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/5. Confirmation Page/Trip Purpose/button.SaveTripPurpose'), 10)
Mobile.tap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Trip Purpose/button.SaveTripPurpose'), 5)
