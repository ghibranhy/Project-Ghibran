...
/**
 * Test Case ID   : TC024
 * Test Name      : 024. Create completed order with Mastercard and promo
 * Description    : Testing flow pemesanan pengiriman menggunakan pembayaran Mastercard dengan penerapan Promo hingga status transaksi diselesaikan via simulator.
...
// 5. Select Payment Mastercard
MobileHelper.tapPaymentOption()
Mobile.delay(2)
waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Payment/selectPaymentMasterCard'), GlobalVariable.TIMEOUT_SHORT)
Mobile.delay(2)
...
// 9. Update Status Simulator (Credit Card = 2)
