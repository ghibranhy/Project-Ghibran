...
/**
 * Test Case ID   : TC020
 * Test Name      : 020. Create completed order with Visa and promo
 * Description    : Testing flow pemesanan pengiriman menggunakan pembayaran Visa dengan penerapan Promo hingga status transaksi diselesaikan via simulator.
...
Mobile.delay(2)
waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Payment/selectPaymentVisa'), GlobalVariable.TIMEOUT_SHORT)
Mobile.delay(2)
