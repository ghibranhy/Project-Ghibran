...
/**
 * Test Case ID   : TC032
 * Test Name      : 032. Create completed order with JCB and promo
 * Description    : Testing flow pemesanan pengiriman menggunakan pembayaran JCB dengan penerapan Promo hingga status transaksi diselesaikan via simulator.
