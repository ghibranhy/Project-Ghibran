...
/**
 * Test Case ID   : TC026
 * Test Name      : 026. Create completed order with Amex
 * Description    : Testing flow pemesanan pengiriman dengan metode pembayaran Amex hingga status transaksi diselesaikan via simulator.
