...
/**
 * Test Case ID   : TC022
 * Test Name      : 022. Create completed order with Mastercard
 * Description    : Testing flow pemesanan pengiriman dengan metode pembayaran Mastercard hingga status transaksi diselesaikan via simulator.
