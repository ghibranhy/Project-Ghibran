...
/**
 * Test Case ID   : TC018
 * Test Name      : 018. Create completed order with Visa
 * Description    : Testing flow pemesanan pengiriman dengan metode pembayaran Visa hingga status transaksi diselesaikan via simulator.
