...
/**
 * Test Case ID   : TC028
 * Test Name      : 028. Create completed order with Amex and promo
 * Description    : Testing flow pemesanan pengiriman menggunakan pembayaran Amex dengan penerapan Promo hingga status transaksi diselesaikan via simulator.
...
// 5. Select Payment Amex
MobileHelper.tapPaymentOption()
Mobile.delay(2)
waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Payment/selectPaymentAmex'), GlobalVariable.TIMEOUT_SHORT)
Mobile.delay(2)
