...
/**
 * Test Case ID   : TC010
 * Test Name      : 010. Add Payment AMEX
 * Description    : Testing flow penambahan metode pembayaran baru berupa Kartu Kredit/Debit berlogo American Express (AMEX).
 * Pre-condition  : Berada di Confirmation Page (Lanjutan dari TC009).
 */
...
// 1. Select & Add Payment Method (Lanjutan dari Confirmation Page TC009)
