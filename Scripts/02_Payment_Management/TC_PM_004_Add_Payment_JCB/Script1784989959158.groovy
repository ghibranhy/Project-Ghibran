...
/**
 * Test Case ID   : TC011
 * Test Name      : 011. Add Payment JCB
 * Description    : Testing flow penambahan metode pembayaran baru berupa Kartu Kredit/Debit berlogo JCB.
 * Pre-condition  : Berada di Confirmation Page (Lanjutan dari TC010).
 */
...
// 1. Select & Add Payment Method (Lanjutan dari Confirmation Page TC010)
...
def cardNumber  = '3528 2033 2456 4357'
