...
Mobile.delay(5)
Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/5. Confirmation Page/Schedule/textView.HourlyTime'), 5)

waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Schedule/button.Tomorrow'), 5)
