...
Mobile.delay(2)
waitForReadyAndTap(findTestObject('Object Repository/Delivery/5. Confirmation Page/Payment/select.PaymentAmexObject Repository/Delivery/5. Confirmation Page/Payment/select.PaymentAmex'))
Mobile.delay(2)
