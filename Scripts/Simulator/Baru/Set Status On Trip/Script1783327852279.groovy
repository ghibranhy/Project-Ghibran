...
String stateValue = "6" // 6 untuk On Trip (Penumpang di dalam mobil)
String orderIdCustom = jobIdAsli.substring(0, 1) + jobIdAsli.substring(2)

println "========== MANIPULASI STATE 6 (ON TRIP) UNTUK ID ESCAPED: ${orderIdCustom} =========="

// 2. Setup Request Object & Headers
RequestObject ro = new RequestObject('SOAP_State_6')
