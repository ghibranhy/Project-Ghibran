...
/**
 * Test Case ID   : TC_RT_006
 * Test Name      : TC_RT_006_Rating_With_Maximum_Tip
 * Description    : Pengujian pemberian custom tip dengan nominal batas maksimum (MAX_TIP) dan rating bintang 5.
 */
...
if (Mobile.waitForElementPresent(customTipBtn, 5, FailureHandling.OPTIONAL)) {
	...
	Mobile.setText(customTipBtn, MAX_TIP.toString(), GlobalVariable.TIMEOUT_SHORT)
	...
	if (Mobile.waitForElementPresent(saveTipBtn, 3, FailureHandling.OPTIONAL)) {
		...
		KeywordUtil.logInfo("Maximum tip berhasil disimpan.")
	}
}
