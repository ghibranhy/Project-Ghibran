...
Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/button.Create.Order'), 3)
Mobile.tap(findTestObject('Object Repository/Delivery/button.Create.Order'), 5)

Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/button.CancelFinding'), 8)
Mobile.tap(findTestObject('Object Repository/Delivery/button.CancelFinding'), 3)

Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/button.CancelReason'), 3)
Mobile.tap(findTestObject('Object Repository/Delivery/button.CancelReason'), 5)

Mobile.waitForElementPresent(findTestObject('Object Repository/Delivery/button.SubmitCancel'), 3)
Mobile.waitForElementAttributeValue(findTestObject('Object Repository/Delivery/button.SubmitCancel'),'enabled', 'true', 3)
Mobile.tap(findTestObject('Object Repository/Delivery/button.SubmitCancel'), 5)
